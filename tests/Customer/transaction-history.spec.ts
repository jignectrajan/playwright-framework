...
test('Transaction history should display correct entries in correct order', async ({ page }) => {
  ...
  console.log('Performing transactions: ₹1000 deposit, ₹500 withdrawal, ₹500 deposit');
  ...
  console.log('Fetching transaction rows');
  ...
  console.log('Validating number of transactions');
